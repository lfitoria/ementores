<section id="prefooter" class="container-full padding-top-bottom">
    <div class="container-fluid d-none d-sm-block d-md-block d-lg-block">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <a href="http://www.ministeriodeeducacion.gob.do/" target="_blank">
                            <img src="/familias/img/footer/LOGO_MINERD.png" alt="Paniamor"
                                class="img-fluid prefooter-logos" style="width: 85%;">
                        </a>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col">
                        ...
                        <div class="res-insti-rp">
                            ...
                            <a href="https://paniamor.org" target="_blank">
                                <img src="/familias/img/footer/footer-logo-paniamor.png"
                                    alt="End Violence Against Children" class="img-fluid prefooter-logos">
                            </a>
            ...
            <div class="col-8 col-sm-8 col-md-4  col-lg-4 col-xl-4 text-opensans mx-auto">
                <p id="prefooter-place">Ministerio de Educación - República Dominicana. Avenida Máximo Gómez esquina
                    Santiago, No.02 Gazcue, Distrito Nacional, República Dominicana.</p>
    ...
    <div class="container-fluid d-block d-sm-none d-md-none d-lg-none">
        <div class="container">
            ...
            <div class="col-12 text-opensans p-0 my-4">
                <p id="prefooter-place">Ministerio de Educación - República Dominicana. Avenida Máximo Gómez esquina
                    Santiago, No.02 Gazcue, Distrito Nacional, República Dominicana.</p>
                <p id="prefooter-phone">809-688-9700</p>
                <p id="prefooter-mail"><a href="mailto:info@minerd.gob.do">info@minerd.gob.do</a></p>
...
<footer id="footer" class="container-full">
    ...
    <div class="container-full footer-bg-3 footer-div-copyright">
        <p class="text-white text-center no-margin-top-bottom text-opensans">Todos los derechos reservados &copy;
            Ministerio de Educación - República Dominicana <?= date("Y") ?></p>
