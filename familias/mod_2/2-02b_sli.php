    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <p class="intro-header blue"><a href="../0-03_menu.php#mod2"  class="icovolver hvr-icon">Volver al<br>menú</a>Crianza tecnológica en tiempos del Internet</p>
                <section class="container">
                    <div class="main">
                        ...
                        <div id="act_01p5" class="d-none module-page">
                            <div class="row align-items-center justify-content-md-center">
                                <h3 class="col-10 text-center">Recomendaciones finales</h3>
                            </div>
                            <div class="row align-items-center justify-content-md-center">
                            <div class="col-sm-10">
