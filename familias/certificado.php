        ...
        <div id="body" style="width: 100%">
            <div class="content">
                ...
                <div class="body">
                    ...
                    <br>
                    <p class="m-d-20"><span class="strong">¡Felicidades!</span> Ahora cuenta con herramientas para promover el uso seguro de internet por parte de niños, niñas y adolescentes.</p>
                    <br>
                    <p>Otorgado el <?php 
