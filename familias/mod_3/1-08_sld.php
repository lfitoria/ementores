...
<body>
    <div class="wrapper">
        <div id="content">
            ...
            <p class="intro-header blue"><a href="../0-03_menu.php#mod1"  class="icovolver hvr-icon">Volver al<br>menú</a>Consecuencias del abuso sexual</p>
            <!-- <section class="container"> -->
                <div class="main">
                    <div id="act_01p1" class="mod act_108_act">
                        ...
                        <button class="gotoModulePage conti conti-ini d-none" data-page="2">Continuar</button>
                        <button class="gotoModulePage btn-start" data-page="2" style="cursor: pointer;">Iniciar</button>
                    </div>
                                ...
                                <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                                    <div class="flipper">
                                        ...
                                        <div class="back b-2">
                                            <ul>
                                                <li>Aislamiento</li>
                                                <li>Dificultades para relacionarse con otros</li>
                                                <li>Agresividad</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                                    <div class="flipper">
                                        ...
                                        <div class="back b-3">
                                            <ul>
                                                <li>Dolor</li>
                                                <li>Problemas al comer</li>
                                                <li>Problemas al dormir</li>
                                                <li>Marcas o golpes en el cuerpo</li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row" >
                                <p class="col-12"><strong>Las consecuencias a corto plazo del abuso sexual pueden incluir:</strong></p>
            ...
            <div class="modal fade" id="modal_1-08_act2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row" >
                                <p class="col-12"><strong>Las consecuencias a largo plazo pueden manifestarse a lo largo de la vida adulta, y pueden incluir:</strong></p>
                                <div class="col-12 col-sm-8">
                                    <ul>
