                                    ...
                                    <div class="menu-mod-cont col-12">
                                        <div class="row">
                                            ...
                                            <div class="row intro-menu col-12 col-sm-10 justify-content-center">
                                                ...
                                                <p style="
                                                font-size: 1.2em;" id="info-p">A continuación encontrará información para aprender más sobre el uso seguro de Internet y las TIC.
                                                </p>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                                <div class="item-module <?php if ($values1[2]["is_completed"] == 1) : ?>active<?php endif ?>">
                                                    <!-- <img src="img/icon.png" alt=""/> -->
                                                    <a href="mod_1/1-03_act.php?t=m" class="v-act-3">Oportunidades y riesgos</a>
                                                    <!--<p class=dots-mod>. . .</p>-->
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                                    <div class="item-module <?php if ($values2[9]["is_completed"] == 1) : ?>active<?php endif ?>">
                                                        <!-- <img src="img/icon.png" alt=""/> -->
                                                        <a href="mod_2/2-02b_sli.php" class="v2-act-2a">¿Cómo aplicar la crianza respetuosa? Algunos ejemplos</a><!--<p class=dots-mod>. . .</p>-->
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                                    <div class="item-module <?php if ($values3[5]["is_completed"] == 1) : ?>active<?php endif ?>">
                                                        <!-- <img src="img/icon.png" alt=""/> -->
                                                        <a href="mod_3/3-08_vid.php" class="v3-act-8">Plan de acción “en acción”</a><!--<p class=dots-mod>. . .</p>-->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
