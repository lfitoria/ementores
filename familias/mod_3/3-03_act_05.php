...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p class="intro-header blue"><a href="../0-03_menu.php#mod3" class="icovolver hvr-icon">Volver al<br>menú</a><a href="3-04_info.php"  class="iconextact hvr-icon">Siguiente</a>Escuchemos: no siempre tenemos la razón</p>
                        ...
                        <div class="cont row mod">
                            ...
                            <div class="d-block d-sm-none">
                                ...
                                <div class="row ">
                                    ...
                                    <a class="gotoModulePage baki" href="3-03_act_04.php">Atrás</a>

                                    <a class="gotoModulePage conti" href="3-03_act_06.php">Continuar</a>
                            ...
                            <a class="gotoModulePage baki d-none d-sm-block" href="3-03_act_04.php">Atrás</a>

                            <a class="gotoModulePage conti d-none d-sm-block" href="3-03_act_06.php">Continuar</a>
