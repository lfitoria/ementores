        ...
        <div id="content">
                ...
                <div class="main">
                    <div id="act_01" class="">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card tab-pane fade ste " id="steven-valeria" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="col-8 col-sm-8 col-md-7 col-lg-7 col-xl-7 mx-auto">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <img src="http://ementores.org/familias/img/footer/footer-logo-endViolence.jpg" alt="End Violence Against Children" class="img-fluid prefooter-logos">
                                </div>
                                <div class="col">
                                    <p class="support-label">Respaldo institucional de:</p>
                                    <img src="http://ementores.org/familias/img/logo-imas.png" alt="End Violence Against Children" class="img-fluid prefooter-logos">
                                </div>
                                <div class="col">
                                    <p class="support-label">Una iniciativa de:</p>
                                    <img src="http://ementores.org/familias/img/footer/footer-logo-paniamor.png" alt="Paniamor" class="img-fluid prefooter-logos">
                                </div>
                                <div class="col"></div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row small-f">
                            ...
                            <div class="col">
                                ...
                                <img src="http://ementores.org/familias/img/logo-imas.png" alt="End Violence Against Children" class="img-fluid prefooter-logos logo-imas">
                            </div>
                            <div class="col">
            ...
            <footer id="footer" class="container-full">
                ...
                <div class="container-full footer-bg-3 footer-div-copyright">
                    <p class="text-white text-center no-margin-top-bottom text-opensans">Todos los derechos reservados &copy; Ministerio de Educación - República Dominicana <?= date("Y") ?></p>
                </div>
            </footer>
        </div>
