...
<body>
    ...
    <script>
        ...
        $("#video1").on("timeupdate", function() {
                ...
                if (parseInt(this.currentTime * 1000) >= 27800 && parseInt(this.currentTime * 1000) <= 27999) {
                    this.pause();
            ...
            $("#video2").on("timeupdate", function() {
                ...
                if (parseInt(this.currentTime * 1000) >= 32700 && parseInt(this.currentTime * 1000) <= 32900) {
                    this.pause();
                    time = 33;
            ...
            $("#video3").on("timeupdate", function() {
                console.log(parseInt(this.currentTime));
                if (parseInt(this.currentTime * 1000) >= 43600 && parseInt(this.currentTime * 1000) <= 43900) {
                    this.pause();
