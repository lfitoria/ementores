        ...
        <div class="wrapper">
            <div id="content">
                <section class="container-full index-main">
                    ...
                    if (is_null($user)) {
                        echo '<script>window.location="http://rd.ementores.org/familias/0-04_intro.php"</script>';
                        die();
                    }
                                               ...
                                               <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                                    <div class="item-module <?php if ($values2[4]["is_completed"] == 1) : ?>active<?php endif ?>">
                                                        <!-- <img src="img/icon.png" alt=""/> -->
                                                        <a href="mod_2/2-05_act.php" class="v2-act-5">“Amistad” en redes sociales ¿Aceptarías estas invitaciones?</a><!--<p class=dots-mod>. . .</p>-->
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
