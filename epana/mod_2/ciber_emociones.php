...
<body>
    ...
    <div class="wrapper">
        <!-- Page Content -->
        <div id="content" class="ciber-emo"> 
            ...
            <div class="rowa header-top">
                ...
                Reconozcamos nuestras emociones en el uso de las TIC
                    ...
                    <div class="main pt-1">
                        <div id="act_01p1" class="mod act_206_act pt-5">
                            <div class="container">
                            <div class="row align-items-center justify-content-md-center">
                                <div class="col-12 col-sm-10">
                                    <div class="intro_2-06">
                                        ...
                                        <!-- <p>Una forma de protegernos consiste en identificar nuestras emociones cuando navegamos e interactuamos con otras personas en Internet.</p> -->
                        ...
                        <div class="row justify-content-center btn-j-center">
                            ...
                            <div class="col-12 col-sm-10">
                                ...
                                <div id="act_01p3" class="d-none mod" style=" padding: 0 !important;">
                                    <br><div class="row align-items-center justify-content-center">
                                        <div class="col-12">
                                            <p class="instruction-label">¿Qué emoción te hace sentir esta situación?</p>
                                        </div>
                                ...
                                <div id="act_01p5" class="d-none mod ">
                                    ...
                                    <button class="gotoModulePage baki d-none d-sm-block" data-page="3">Atrás</button>
                                    <button class="gotoModulePage conti d-none d-sm-block" data-page="6">continuar</button>
                                </div>
                                <!-- <div id="act_01p5" class="d-none mod ">
                                    <br><div class="row align-items-center justify-content-center">
                                        <div class="col-12">
                                    ...
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-12 col-md-8" >
                                            <p class="explication-label">Una persona te pide que le mandés fotos íntimas.
                                    ...
                                    <button class="gotoModulePage baki d-none d-sm-block" data-page="4">Atrás</button>
                                    <button class="gotoModulePage conti d-none d-sm-block" data-page="6">Continuar</button>
                                </div> -->
                            </div>
                        </div>
    ...
    $('#sit-extorcion').on('click', function (event){ 
     ...
     $('#sit-extorcion-modal').modal('show')
            ...
            $(".main a").click(function () {
                var btnPressText = $(this).text();
                var btnPressClass = $(this).data("modl");

                $(".act-04-mdl").addClass("d-none");
                $(".act-04-mdl.act-" + $(this).data("modl")).removeClass("d-none");
                ...
                $(".act-04-mdl.act-" + $(this).data("modl") + " audio")[0].play();
            });
