...
<body>
            ...
            // $last_id = $user["id"];
            $certificate = (!empty($_SESSION['nombre'])) ? $_SESSION['nombre'] : '';
            

            if (is_null($user)) {
                echo '<script>window.location="http://rd.ementores.org/epana"</script>';
                die();
            }
                            ...
                            <div class="col-sm-offset-1 col-sm-10 main-block end">
                                ...
                                <form <?php echo $display;?> action="output.php" target="_blank" method="POST" id="output">
                                    ...
                                    <div class="form-group email-input">
                                        ...
                                        <p class="text-center label-small quest-email">Nombre completo (este aparecerá en el certificado)</p>

                                        <input type="text" name="name" id="name" value="<?php echo $certificate;?>" class="form-control mr-auto" placeholder="Nombre completo" >
