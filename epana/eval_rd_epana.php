    ...
    <div id="page-wrap">
        <form action="eval_rd_epana_result.php" method="post" id="quiz">
                ...
                <div class="cont row">
                    <div class="col-12 col-sm-8"">
                        ...
                        <div class="controwbox">
                            ...
                            <p class="label-info">A continuación encontrarás una <strong>serie de enunciados.</strong></p>
                            <p class="label-info">Analízalas y selecciona si consideras que la frase es <strong>Falsa o Verdadera</strong>
                            </p>
            ...
            <div class="box-quest container-box">
                ...
                <input type="radio" name="question-<?= ($item["id"])  ?>-answers" id="question-<?= ($item["id"])  ?>-answers" value="F" required data-page="<?php echo ($key) ; ?>"/>
                <img src="img/reto/ico-f.png" alt="">
                </label>
                <label class="label-instruction">Elije una opción</label>
                <label class="btn-true">
                <input type="radio" name="question-<?= ($item["id"])  ?>-answers" id="question-<?= ($item["id"])  ?>-answers" value="V" required data-page="<?php echo ($key) ; ?>"/>
