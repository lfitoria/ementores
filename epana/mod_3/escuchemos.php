                        ...
                        <div class="cont row">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="item item-thumb" data-slider="1" data-title="Abuso sexual en línea">
                                    <a href="escuchemos_act_01.php"><img src="../img/mod3/3-03_act-thumb1_rp.png" alt="" class="img-fluid" /></a>
                                </div>
                            </div>
                            <div class="col-6 col-md-4">
                            ...
                            <p class="intro-header blue"><a href="../" class="icovolver hvr-icon">Volver al inicio</a>
                            </p>
                        </div>
                    </div>
                </div>
