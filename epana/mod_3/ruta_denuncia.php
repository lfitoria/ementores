        ...
        <div class="wrapper">
            ...
            <div id="content"> 
                ...
                <section class="container">
                    ...
                    <div class="btn-na">
                    <a href="../mod_2/huelladigital.php#titleancla" class="iconextact hvr-icon">Siguiente</a>
                </div>
                        ...
                        <div id="act_01" class="">
                            <div class="cont row">
                                <div id="map_container">
                                    <img usemap="#3-07-inf" id="img-map" src="../img/mod3/3-07_inf_familias_ePana.png" class="img-fluid">
                                    <map name="3-07-inf">
