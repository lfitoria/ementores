            ...
            <!-- <section class="container"> -->
                <div class="main">
                    ...
                    <div id="act_01p4" class="d-none mod " >
                        <div class="container" style=" position: relative;padding: 0 8%;">
                        <div class="row">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-12 col-sm-8">
                                    <ul>
                                        ...
                                        <li>Baja autoestima </li>
                                        <li>Aslamiento y apatia para actividades que antes difrustaba.</li>
                                        <li>Enfermedades, dolor y malestar físico</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-12 col-sm-8">
                                    <ul>
                                        ...
                                        <li>Ideas suicidas o intentos de suicidio</li>
