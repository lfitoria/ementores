                    ...
                    <div class="main">
                        <div id="act_01" class="mod">
                            ...
                            <div id="map_container">
                                    <img usemap="#1-02-inf" src="/familias/img/mod1/1-02_inf_RD_2020.png" class="img-fluid">
                                    <map name='1-02-inf'>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row d-none act-04-mdl act02" >
                                        <div class="col-12">
                                            ...
                                            Las personas usuarias pueden subir fotos o vídeos y agregarles filtros fotográficos y efectos. Además las personas usuarias pueden usar hashtags (palabras clave precedidas por el signo #) para identificar de qué tipo de imagen se trata. <br><br>En Instagram las fotografías son, por defecto, públicas y hay que modificar las variables de publicación para que puedan verlas sólo nuestros seguidores. 
                                        </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row d-none act-04-mdl act08" >
                                        <div class="col-12">
                                            ...
                                            Permite compartir textos cortos que no superen 280 caracteres. Estos textos se conocen como “twits”. <br><br>Es importante recordar que todo lo que publicamos en Twitter es, por default, público y se convierte en parte de nuestra identidad digital. Importantes figuras de la política y celebridades han debido pedir disculpas públicas o perdido su trabajo porque publican un “twit” ofensivo o discriminatorio.
                                        </div>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="row d-none act-04-mdl act09" >
                                        <div class="col-12">
                                            <div class="row">
                                            <div class="col-12 col-sm-3"><img src="/familias/img/mod1/1-02_icn-tkk.png"></div> 
                                            <div class="col-12 col-sm-9">
                                            <a href="https://www.tiktok.com/">tiktok.com</a><br>
                                            Las personas usuarias pueden subir vídeos de máximo 60 segundos y agregarles filtros y efectos. Además pueden interactuar con los contenidos subidos por otros usuarios: reaccionar, crear duetos, darle me gusta, comentar y enviar mensajes directos. Adicionalmente, si así lo tiene definido la persona usuario, su contenido se puede compartir en otras redes sociales y descargar. <br>El contenido compartido es público, pero se puede modificar las variables de publicación para que puedan verlas sólo nuestros seguidores, así como restringir el tipo de interacción que se permite en los videos. <br> La edad mínima permitida para crear una cuenta en TikTok es 13 años.  
                                        </div>
                                        </div>
                                        </div>
                                    </div>
