...
<div class="subfooter-box">
    <!-- <img class="d-none d-sm-block" src="/ecompa/img/personaje1_footer.png"> -->
<div class="container" >
    <div class="row">
        <div class="col-sm-4 imgsubfo" >
                
                <img class="d-none d-sm-block" src="/ecompa/img/personajes_footer.png">
        </div>
        <div class="col-sm-4 contact-nube">
            <h2>Contacto</h2>
...
<section id="prefooter">
    <div class="container">
            <div class="row">
                    ...
                    <div class="col-md-6">
                            <div class="row">
                                    <div class="col-md-5"><span class="subtitle">Con el apoyo de:</span>
                                    <p><a href="http://www.end-violence.org/" target="_blank"><img alt="End Violence Against Children" class="img-fluid" data-entity-type="file" data-entity-uuid="2f3106ad-0c52-44cb-986f-42d9d3b6f503" src="/sites/default/files/inline-images/logo-violence.png" /></a></p>
                                    </div>
                                    
                                    <div class="col-md-7 inibox"><span class="subtitle">Una iniciativa de:</span>
                                    
                                    <p><img alt="Cr-NEXST" data-entity-type="file" data-entity-uuid="567bc22c-cd0c-465d-800a-e3bd1f05673b" src="/sites/default/files/inline-images/logo-crnext.png" /><a href="https://paniamor.org/" target="_blank"><img alt="Paniamor" data-entity-type="file" data-entity-uuid="4a9fb68a-0a87-42ec-ba77-f94e2633b407" src="/sites/default/files/inline-images/logo-paniamor.png" /></a></p>
                                    </div>
                                    </div>
            ...
            <div class="row logosbottom">
                    <div class="col-md-8 ">
                        <p class="subtitle">Con la participación de:</p>
                
                        <div class="box-i-logos-apoyo"><a target="_blank" href="https://www.micit.go.cr/"><img alt="Micitt" data-entity-type="file"
                                    data-entity-uuid="57780b10-db7d-4135-af42-96b46a9ff336"
                                    src="/sites/default/files/inline-images/logo-micitt_0.png" /></a><a target="_blank"
                                href="https://www.seguridadpublica.go.cr/"><img alt="Fuerza Pública" data-entity-type="file"
                                    data-entity-uuid="9256d2d9-9649-4c5b-9267-c41f1f7f7a0c"
                                    src="/sites/default/files/inline-images/logo-fuerzaP-01.png" /></a> <a target="_blank"
                                href="https://www.imas.go.cr/"><img alt="IMAS" data-entity-type="file"
                                    data-entity-uuid="d2621df1-9ab0-47e8-81a7-5912f083e498"
                                    src="/sites/default/files/inline-images/logo-imas_0.png" /></a> <a target="_blank"
                                href="https://www.ccss.sa.cr/"><img alt="CCSS" data-entity-type="file"
                                    data-entity-uuid="8c2ea09f-181d-4d0e-b9d9-f144b052fe1c"
                                    src="/sites/default/files/inline-images/logo-seguros-01.png" /></a> <a target="_blank"
                                href="https://www.cen-cinai.go.cr/"><img alt="CENCINAI" data-entity-type="file"
                                    data-entity-uuid="bebdd8af-6fea-4a68-aad0-edd3aea5e651"
...
<!--     <div class="container-full footer-bg-1 padding-top-bottom-footer"></div>
    ...
    <div class="footer-bg-3 footer-div-copyright">
        <p class="text-center no-margin-top-bottom text-opensans">Todos los derechos reservados &copy; Fundación Paniamor 2019</p>
    </div>
</footer>
...
<div class="modal fade modal_encuesta" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <h3>¿Qué te parece <img src="https://ementores.org/themes/gestion/img/e-compas_color.png">?</h3>
...
<div id="encuesta">
  <div class="carousel-inner">
    ...
    <div class="carousel-item ">
     ...
     <div class="carousel-item ">
        <div class="form-group email-input">
            <p class="text-center label-small quest-email"><strong> ¿Qué aprendiste hoy que compartirías con tus compas?</strong></p>
        ...
        // } 
         ...
         $('#submit').on('click', function(){
            ...
            if (q1 == undefined) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'https://ementores.org/ecompa/db/user/insertar_encuesta.php',
