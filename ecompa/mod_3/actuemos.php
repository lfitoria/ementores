...
<head>
    ...
    <link rel="icon" href="http://www.ementores.org/ecompa/favicon.ico" type="image/gif">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:url" content="http://www.ementores.org/ecompa" />
    ...
    <meta property="og:image" content="http://www.ementores.org/ecompa/OG_e-compas.png" />
...
<button class="encuesta-modal" data-toggle="modal" data-target=".modal_encuesta">
    <p>Qué te parece</p>
    <img src="https://ementores.org/themes/gestion/img/e-compas_color.png">
</button>
...
<div id="boxelo">
    <div id="logo-flotante">
        <h1>
            <a href="/ecompa">
                <img alt="e-compa: Uso seguro de las tecnologías e internet para chicos y chicas" src="http://ementores.org/ecompa/img/icono-e-compas.png">
            </a>
        </h1>
    </div>
    <div id="logo-texto">
    ...
    <div class="wrapper">
            ...
            <section class="container">
                ...
                <div class="row align-items-center justify-content-md-center">
                    <div class="col-12 col-sm-8 p-ins">
                        ...
                        <p id="info-p"><strong>Hacé clic en las pestañas para ver los videos. Cuando se le presente una pregunta, elija la opción que considere adecuada.
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12 col-md-6">
                                                                            <button class="btn btn-info" style="display: block; width: 100%; white-space: normal;" onclick="playVideo()">Contarle a su mamá y sacar pantallazos de los mensajes para que sirvan de prueba en una denuncia</button>
                                                                            <br>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12 col-md-6">
                                                                            <button class="btn btn-info" style="display: block; width: 100%; white-space: normal;" onclick="playVideo()">Contarle a una persona de confianza y juntas poner la denuncia.</button>
                                                                            <br>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <p class="font-weight-bold">Eric es un chico de 17 años que conoció a Mario en redes sociales. <br> Un día su papá le pregunta con quién pasa hablando todo el día y Eric le responde que es sólo un amigo llamado Mario. "¿Del colegio?", pregunta su papá. "No", responde Eric, "lo conocí en Facebook". Unos días después, su papá busca el perfil de Mario en Facebook y descubre es un adulto de 34 años. Preocupado, le pide a Eric alejarse Mario. </p>
                                                                    <p class="font-weight-bold h4">¿Qué debe hacer Erick?</p>
                                                                    <div class="row">
                                                                        <div class="col-12 col-md-6">
                                                                            <button class="btn btn-info" style="display: block; width: 100%; white-space: normal;" onclick="playVideo()">Escuchar a su tío y alejarse de Mario. Las relaciones sexuales entre menores de edad y adultos no son adecuadas y esta situación puede volverse difícil de manejar.</button>
                                                                            <br>
                                                                        </div>
                                                                        <div class="col-12 col-md-6">
                                                                            <button class="btn btn-info" style="display: block; width: 100%; white-space: normal;" onclick="playVideo()">Seguir hablando con Mario como si nada. De por sí, él ya está grande y puede escoger con quién se mete.</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <script>
            ...
            $("#video2").on("timeupdate", function() {
                ...
                if (parseInt(this.currentTime * 1000) >= 33100 && parseInt(this.currentTime * 1000) <= 33200) {
                    this.pause();
                    time = 24;
